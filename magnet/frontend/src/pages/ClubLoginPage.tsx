      ...
      <div className="w-full max-w-[350px] space-y-3">
        <div className="rounded-sm border border-gray-200 bg-white p-10 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-6 text-center">
            <Users className="mx-auto h-12 w-12 text-rose-500" />
            <h1 className="mt-3 text-2xl font-semibold bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent">Magnet</h1>
            <p className="mt-1 text-sm font-medium text-gray-500">Club Portal</p>
          </div>
        ...
        <div className="rounded-sm border border-gray-200 bg-white p-5 text-center dark:border-gray-800 dark:bg-gray-900">
          <p className="text-sm text-gray-500">Don't have an account? <Link to="/register" className="font-semibold text-[#0095f6]">Sign up</Link></p>
        </div>
