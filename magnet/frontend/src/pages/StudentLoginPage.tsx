      ...
      <div className="w-full max-w-[350px] space-y-3">
        ...
        <div className="rounded-sm border border-gray-200 bg-white p-10 dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-3 text-2xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              Magnet
            </h1>
            <p className="mt-1 text-sm font-medium text-gray-500">Student Portal</p>
          </div>
          ...
          <p className="text-center text-xs text-[#385185] font-semibold cursor-pointer">
            Forgot password?
          </p>
        </div>
