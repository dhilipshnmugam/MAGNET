  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'story-pulse': 'storyPulse 2.5s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'viewer-in': 'viewerIn 0.25s cubic-bezier(0.16, 1, 0.3, 1)',
        'viewer-out': 'viewerOut 0.2s ease-in forwards',
        'viewer-backdrop': 'fadeIn 0.25s ease-out',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
